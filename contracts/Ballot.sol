...
contract Ballot {
    ...
    function giveRightToVote(address voter) external {
        // If the first argument of 'requrie' evaluates
        // to 'false', execution termincates and all
        // changes to the state and to Ether balances
        // are reverted.
        // This used to consume all gas in old EVM versions, 
        // but not any more.
    ...
    function delegate(address to) external {
        ...
        // because if they run too long, they might need
        // more gas than is available in a block
        // In this case, the delegation will not be executed,
        // but in other situations, such loops might cause a
        // contract get "stuck" completely.
